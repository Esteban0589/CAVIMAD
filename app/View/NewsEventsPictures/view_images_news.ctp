...
<div class="container">
	<div class="row">
		<div class="view_images index col-md-12">
			<div class="row">
				<h1>
					<?php echo $this->Html->link(__(''), array('controller'=>'news','action' => 'view',$id), array('class' => 'glyphicon glyphicon-arrow-left','title' =>'Volver a detalles de noticia', 'style'=>'color: #3891D4; font-size:25px; padding: 5px;')); ?>
					<?php echo __('Imágenes de noticia'); ?>
				</h1>
				...
				<div class="container">
					<div class="row">
						<?php if($this->Session->read('role') =='Administrador'): ?>
							<div class="view_images form col-md-6">
    							...
    							<fieldset>
    							<h3><?php echo __('Agregar imagen de Noticia'); ?></h3>
    							<?php
    								...
    								echo $this->Form->input('news_id',array('type' =>'hidden', 'default'=>$id));

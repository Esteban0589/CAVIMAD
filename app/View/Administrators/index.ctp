<div class="administrators index">
	...
	<tr>
		...
		<td><?php echo h($administrator['Administrator']['specialty']); ?>&nbsp;</td>
		<td><?php echo h($administrator['Administrator']['curriculum']); ?>&nbsp;</td>
		<td><?php echo h($administrator['Administrator']['institution']); ?>&nbsp;</td>
		<td><?php echo h($administrator['Administrator']['publication']); ?>&nbsp;</td>
		<td>

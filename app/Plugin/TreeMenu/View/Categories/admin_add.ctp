    	...
    	<div class="container"><!-- container -->
            ...
            <div class="row"><!-- row -->
				...
				<div class="col-lg-12 col-md-12"><!-- doc body wrapper -->
					...
					<ul class="breadcrumb">
					    <li>
							<?php echo $this->Html->link(__('Administrar').' '.$humanizeAlias, array('action'=>'index', 'alias'=>$alias));?>
							<span class="divider">/</span>
						</li>
					    <li class="active"><?php echo __('Agregar').' '.$humanizeAlias; ?></li>
					</ul>
					<?php echo $this->Form->create('Categoria', array('class'=>'form-horizontal'));?>
						<fieldset>
							<legend><?php echo __('Agregar').' '.$humanizeAlias; ?></legend>
						<?php
